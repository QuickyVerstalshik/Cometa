...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{display: "block", background: "url(img/right-arrow.svg)",  backgroundPosition:'center',}}
      onClick={onClick}
    ></div>
  );
}
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{display: "block", background: "url(img/left-arrow.svg)",   backgroundPosition:'center',}}
      onClick={onClick}
    />
  );
}
